...
class UserPreference(Base):
    ...
    theme_color: Mapped[str] = mapped_column(sa.String(32), default='lake-view', comment='颜色预设 default/lake-view/...')
    ...
    profile_cover: Mapped[str | None] = mapped_column(sa.String(500), default=None, comment='个人资料页背景图路径，同头像存 /static/upload/cover/xxx')
